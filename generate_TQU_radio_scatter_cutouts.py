...
tMap = hp.read_map(pathOut + "t_radio_sehgal_"+nuStr+"ghz_muk_scatter.fits")
qMap = hp.read_map(pathOut + "q_radio_sehgal_"+nuStr+"ghz_muk_scatter.fits")
uMap = hp.read_map(pathOut + "u_radio_sehgal_"+nuStr+"ghz_muk_scatter.fits")
...
#         np.savetxt(pathOut + "ps_sehgal_"+nuStr+"ghz_T_patch"+str(nPatches)+".txt", cutTMap)
         np.savetxt(pathOut + "ps_sehgal_"+nuStr+"ghz_Q_patch"+str(nPatches)+"_scatter.txt", cutQMap)
         np.savetxt(pathOut + "ps_sehgal_"+nuStr+"ghz_U_patch"+str(nPatches)+"_scatter.txt", cutUMap)
