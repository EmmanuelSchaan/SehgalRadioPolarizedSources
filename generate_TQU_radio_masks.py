...
def generateMask(iPatch):
   ...
   # read the cutout
   pathCutout = pathOut + "ps_sehgal_"+nuStr+"ghz_T_patch"+str(iPatch)+".txt"
   ...
   # save mask
   pathMask = pathOut + "ps_mask_"+nuStr+"ghz_"+str(np.int(round(fluxCutmJy)))+"mJy_beam"+str(round(beamFwhm,1))+"_noise"+str(round(noiseT,2))+"_lknee"+str(np.int(lKnee))+"_aknee"+str(round(aKnee,1))+"_T_patch"+str(iPatch)+".txt"
